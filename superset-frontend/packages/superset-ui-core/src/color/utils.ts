...
export function rgbToHexWithAlpha(red: number, green: number, blue: number, opacity: number = 1): string {
  if (opacity < 0 || opacity > 1) {
    throw new Error(`The opacity should be between 0 and 1, but got: ${opacity}`);
  }
